...
Currently working on my own startup, i.e., **Neural Nurture**, where we're inspiring the Future of AI Through Research and Innovation.

I completed my Ph.D. from the Tokyo Institute of Technology (Tokodai) in Computer Vision at [Okutomi Tanaka Lab](http://www.ok.sc.e.titech.ac.jp/index.shtml). My supervisors were Professors [Masayuki Tanaka](http://www.ok.sc.e.titech.ac.jp/~mtanaka/), and [Masatoshi Okutomi](http://www.ok.sc.e.titech.ac.jp/mem/mxo/okutomi.html). Moreover, I was collaborating with [Hugo Larochelle](https://scholar.google.com/citations?user=U89FHq4AAAAJ&hl=en) on ML generalization and computer vision research topics. My publications, patents, and other research related activities are available on **[Research](https://dineshdaultani.github.io/research/)** tab.  
